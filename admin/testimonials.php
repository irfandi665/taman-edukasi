													...
													<tr>
														...
														<td><?php if ($result->status == "" || $result->status == 0) {
															...
															<?php } else { ?>
																...
																<a href="testimonials.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you really want to Inactive')" style="padding: 5px 10px; background-color: green; color: white; text-decoration: none; border-radius: 4px;"> Active</a>
														</td>
													<?php } ?></td>
													</tr>
											<?php $cnt = $cnt + 1;
